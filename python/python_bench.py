...
from cython_bench import sum_even_numbers_cy_1, sum_even_numbers_cy_1_1, sum_even_numbers_cy_2, sum_even_numbers_cy_2_1
...
if __name__ == '__main__':
    ...
    start_at = time.process_time()
    res = sum_even_numbers_cy_1_1(2, 20_000_000)
    print(f"sum_even_numbers_cy_1_1: {time.process_time() - start_at}s")
    print(f"sum_even_numbers_cy_1_1: {res}")
    ...
    start_at = time.process_time()
    res = sum_even_numbers_cy_2_1(2, 20_000_000)
    print(f"sum_even_numbers_cy_2_1: {time.process_time() - start_at}s")
    print(f"sum_even_numbers_cy_2_1: {res}")
